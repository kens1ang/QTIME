...
<template>
    <Layout>
        <PageHeader title="Attendance Summary" pageTitle="Attendance" subTitle="" />
        <BRow>
          <BCol xl="12" lg="12">
          <BRow class="g-3">
                            <BCol xl="12">
                ...
                <BTabs nav-class="nav-pills nav-justified custom-nav">
                  <BTab active class="nav-item nav-link p-3">
                    ...
                    <div>
                      ...
                      <h6 class="mb-1">Date : 1-Sep-2024 to 15-Sep-2024</h6><br>
                    </div>
                    <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <div class="edit">
                                                <button class="btn btn-sm btn-success edit-item-btn" @click="showModal(true)">Detail</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                  ...
                  <BTab class="nav-item nav-link fs-15 p-4">
                    ...
                    <BCardBody>
                      <div class="row align-items-center">
                        ...
                        <label class="col-auto form-label mb-0">Select Date</label>
