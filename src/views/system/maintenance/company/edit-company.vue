...
<div class="d-flex justify-content-end">
  <BButton  class="btn btn-outline-success waves-effect waves-light material-shadow-none"  href="/system/company-detail/"
  >Back</BButton>
  <BButton style="margin-left: 10px;" type="button" variant="primary" class="w-sm" href="/system/company-detail">
    Update
  </BButton>
</div>
