...
<template>
    <Layout>
        <PageHeader title="Schedule" subTitle="Maintenance List" pageTitle="System" />
        <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div class="file-manager-sidebar border" style="min-width: 230px !important">
                <div class="p-4 d-flex flex-column h-100">
                    <div class="mb-3">
                        <BButton variant="primary" class="w-100" @click="projectModal = !projectModal"><i
                                class="ri-add-line align-bottom"></i> Add Code</BButton>
                    </div>
            ...
            <div class="file-manager-content w-100 p-4 pb-0 border">
                ...
                <div class="todo-content position-relative px-4 mx-n4" id="todo-content">
                    ...
                    <div class="todo-task" id="todo-task" style="font-size: 14px;">
                            ...
                            <table class="table align-middle position-relative table-nowrap">
                                <thead class="table-active">
                                    <tr>
                                        ...
                                        <th scope="col"></th>
                                        <th scope="col">Start Work Hour</th>
                                        <th scope="col"></th>
                                        <th scope="col">End Work Hour</th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead>
                                ...
                                <tbody id="task-lists">
                                    <tr>
                                        <td><input type="text" value="Monday" /></td>
                                        <td><input type="text" value="8" /></td>
                                        <td>From</td>
                                        <td><input type="text" value="8:00" /></td>
                                        <td>To</td>
                                        <td><input type="text" value="17:00" /></td>
