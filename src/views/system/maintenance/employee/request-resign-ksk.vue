            ...
            ></i>
                            ...
                            <BRow class="g-3">
                               <BCol sm="5"></BCol>
                                ...
                                <div>
                                    <BLink href="/system/employee-qr" class="w-100">
                                        <BButton type="button" variant="success" class="w-100" style="font-size: 12px;">
                                            <i class="ri-qr-code-line me-2 align-bottom"></i>Bulk Approve
                                        </BButton>
                                    </BLink>
                                </div>
                                </BCol>
                                ...
                                <div>
                                    <BLink href="/system/employee-qr" class="w-100">
                                        <BButton type="button" variant="danger" class="w-100" style="font-size: 12px;">
                                            <i class="ri-qr-code-line me-2 align-bottom"></i>Bulk Reject
                                        </BButton>
                                    </BLink>
                                </div>
                                </BCol>
                    ...
                    <BCardBody>
                        ...
                        <div class="table-responsive table-card mb-1">
                            ...
                            <thead class="table-light text-muted">
                                ...
                                <th></th>
                                <th class="sort" data-sort="customer_name" @click="onSort('customer')">Date Request</th>
                                ...
                                <th class="sort" data-sort="email" @click="onSort('email')">Location</th>
                                <th class="sort" data-sort="phone" @click="onSort('phone')">AA Permit</th>
                                <th class="sort" data-sort="phone" @click="onSort('phone')">Status</th>
                                <th class="sort" data-sort="phone" @click="onSort('phone')">Remark</th>
                                <th class="sort" data-sort="date" @click="onSort('date')">Request By</th>
                                </tr>
                            </thead>
                            <tbody class="list form-check-all">
                                ...
                                <td>{{ item.date }}</td>
                                <td class="phone">{{ item.id }}</td>
                                <td class="customer_name">{{ item.customer_name }}</td>
                                <td class="email">{{ item.email }}</td>
                                <td class="date">{{ item.rfid }}</td>
                                <td class="date"><span class="badge bg-warning-subtle text-warning" >
                                            {{ item.status }}
                                </span></td>
                                <td></td>
