    ...
    <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
      ...
      <li class="nav-item">
        <a
          ...
          @click.prevent="setTab('workOrder')"
          href="#"
        >
          Work Order
          <span class="badge bg-danger-subtle text-danger">1</span>
      ...
      <li class="nav-item">
        <a
          ...
          @click.prevent="setTab('registration')"
          href="#"
        >
          Registration
          <span class="badge bg-danger-subtle text-danger">1</span>
      ...
      <li class="nav-item">
        <a
          ...
          @click.prevent="setTab('resignation')"
          href="#"
        >
          Resignation
        </a>
          ...
          <table class="table align-middle table-nowrap" id="customerTable">
            ...
            <tbody class="list form-check-all">
              <tr>
                ...
                <td>04 2022</td>
                <td>2020-07-24 15:45:20</td>
                <td>2021-01-17</td>
                <td>yktan 2023-09-26 09:52:13</td>
                <td></td>
                <td>RM 56,055.35</td>
              </tr>
            </tbody>
