    ...
    <BCardBody>
      ...
      <div class="mt-3">
        ...
        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
          ...
          <div>
            <span class="text-muted pe-5">125 Tasks</span>
          </div>
        </div>
        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
          <p class="fw-medium mb-0">
          ...
          <div>
            <span class="text-muted pe-5">42 Tasks</span>
          </div>
        </div>
        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
          <p class="fw-medium mb-0">
          ...
          <div>
            <span class="text-muted pe-5">58 Tasks</span>
          </div>
        </div>
        <div class="d-flex justify-content-between py-2">
          ...
          <div>
            <span class="text-muted pe-5">89 Tasks</span>
          </div>
        </div>
      </div>
    </BCardBody>
